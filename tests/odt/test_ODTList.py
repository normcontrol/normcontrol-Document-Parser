...
class TestODTList(unittest.TestCase):
    ...
    def test_get_lists_styles(self):
        ...
        self.assertEqual(lists_styles[1], List(_list_type=None, _list_name='WW_CharLFO5LVL1', _list_level=None,
    ...
    def test_get_list_styles_from_automatic_styles(self):
        ...
        self.assertEqual(lists_styles[0], List(_list_type=None, _list_name='LFO1', _list_level='9',
